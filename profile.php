      ...
      <div class="row align-items-center">
        ...
        <div class="col-lg-4 order-last">
          <ul class="list-unstyled d-flex align-items-center justify-content-center justify-content-lg-start my-3 gap-3">
            ...
            <!-- <li><a class="btn btn-primary" href="update_profile.php">update profile</a></li> -->
          </ul>
        </div>
      </div>
    ...
    <div class="tab-pane fade" id="pills-friends" role="tabpanel" aria-labelledby="pills-friends-tab" tabindex="0">
      ...
      ?>
        <div class="alert alert-success" role="alert">
          <strong>Done</strong> download completed
        </div>
      ...
      ?>
      <?php
      if (isset($_GET['msg']) && $_GET["msg"] == "content is required") {
        # code...
      ?>
        <div class="alert alert-danger" role="alert" id="elementToHide">
          <strong>Error</strong> please complete your post
        </div>
          ...
          ?>
            <div class="col">
              <div class="card shadow-sm">
                ...
                if (!empty($post["image"])) {
                ?>
                  <img src="<?= $post["image"] ?>" class="bd-placeholder-img card-img-top" width="100%" height="225" alt="">
                <?php
                }
                ?>
                <small class="text-primary mt-2 mx-2"><?= $post["updated_at"] ?></small>
